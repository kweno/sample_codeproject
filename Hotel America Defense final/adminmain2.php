...
<div class="style50" id="apDiv28"><a href="adminmain.php">RESERVATION DATA</a></div>
<p>&nbsp;</p>
<p>&nbsp;</p>

<div class="style50" id="apDiv29"><a href="adminmain2.php">REGISTER DATA</a></div>
<p>&nbsp;</p>
...
<div id="apDiv25"><a href="adminlogout.php"><font size="3">Logout</font></a></div>
<?php 
include 'mysql.php';
...
$admin = mysql_query("SELECT * FROM users ");
			echo "<div id='apDiv26'><table border='1' style='border:0px;' width='100%' cellpadding='2' cellspacing='10'>
			<tr >
			...
			echo "<td  align='center'>" ."<font color='#333333' face='trebuchet ms'>". $row['user_id'] ."</font>"."</td>";
			...
			echo "<td align='center'>" ."<font color='#333333' face='trebuchet ms'>" . $row['user_password'] ."</font>"."</td>";
			...
			echo'<div id="apDiv27"><form method="post" action="del2.php">
    <label><span class="style1 style3">Please Enter the Id number you want to DELETE<br>
    </span>
    </span>
