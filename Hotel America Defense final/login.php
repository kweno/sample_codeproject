...
<div id="menu">
    <ul class="menu">
      <li><a href="index.php" class="parent"><span class="style45">Home</span></a></li>
        
        <li><a href="accomodation.php"><span>Accomodation</span></a>
            <div><ul>
                <li><a href="#"><span>Deluxe Double Bed</span></a></li>
                <li><a href="#"><span>Deluxe 2 Single Bed</span></a></li>
                <li><a href="#"><span>Executive Double Bed</span></a></li>
                <li><a href="#"><span>Executive 2 Single Bed</span></a></li>
                <li><a href="#"><span>Presidential Suite</span></a></li>
                <li><a href="#"><span>Deluxe Presidential w/ Jacuzzi</span></a></li>
              <li><a href="#"><span>Super Deluxe Double Bed</span></a></li>
                 <li><a href="#"><span>Super Deluxe Executive</span></a></li>
                 <li><a href="#"><span>Super Deluxe Presidential w/ Jacuzzi</span></a></li>
...
<div id="apDiv22">
  <form id="form1" name="form1" method="post" action="">
    <label>
      <span class="style49">Username: 
    &nbsp;&nbsp;&nbsp;&nbsp;
    <input type="text" name="username" id="textfield" />
    </span></label>
    <p class="style48">&nbsp;</p>
    <p class="style49">Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <label>
    ...
    <p>
      <label>
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" style="border: groove1px solid #cccccc; background-color: #ffffff; value=" value="Login">
      </label>
      <label></label>
</p>
  </form>
...
<div class="jMyCarousel">
  <ul>
    ...
    <img src="jMyCarousel/jMyCarousel/examples/carousel_img/1/caro1.jpg" width="200" height="150" /></a> 
    <a href="pix hotel/grey/crew.jpg" rel="gb_imageset[nice_pics]" title="America Hotel Staff">
    <img src="jMyCarousel/jMyCarousel/examples/carousel_img/1/caro8.jpg" width="200" height="150" /> </a>
    ...
    <img src="jMyCarousel/jMyCarousel/examples/carousel_img/1/caro2.jpg" width="200" height="150" /></a>
    <a href="pix hotel/grey/resto.jpg" rel="gb_imageset[nice_pics]" title="America Hotel Resto">
     <img src="jMyCarousel/jMyCarousel/examples/carousel_img/1/caro6.jpg" width="200" height="150" /></a> 
...
<div id="apDiv20">
  <table width="598" height="35" border="0" align="center" class="style44">
    <tr>
      <td><span class="style52">| <a href="index.php">HOME</a> |</span></td>
      <td><span class="style52">| <a href="accomodation.php">ACCOMODATION</a> |</span></td>
      <td><span class="style52">|<a href="reservation2.php"> RESERVATION</a> |</span></td>
      <td><span class="style52">| <a href="about_us.php">ABOUT US</a> |</span></td>
      <td><span class="style52">| <a href="credits.php">CREDITS </a>|</span></td>
    </tr>
  </table>
</div>
