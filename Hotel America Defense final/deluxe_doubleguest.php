...
<div id="menu">
  ...
  <li><a href="accomodation.php"><span>Accomodation</span></a>
      ...
      <li class="last"><a href="credits.php"><span>Credits</span></a></li>
...
<div id="apDiv33">Welcome, <strong><font size="2">Guest</font></strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to America Hotel</div>
<p>&nbsp;</p>
...
<div id="apDiv20">
  <table width="598" height="35" border="0" align="center" class="style44">
    <tr>
      ...
      <td>| <a href="accomodation.php">ACCOMODATION</a> |</td>
      <td>| <a href="reservation2.php">RESERVATION</a> |</td>
...
<form id="form1" method="post">
    				<input type="submit" name="login" style="border: groove1px solid #cccccc; background-color: #ffffff; value=" value="Login"Submit>
	<label>
...
echo'<script>alert("If you are not a member Please Register First");</script>';
